---
title: HTTP
description: HTTP와 관련된 모든 개념들에 대해
slug: HTTP
publishedAt: 2025-10-24T05:04:59.909Z
updatedAt: 2026-08-23T13:35:03.136Z
category: web-app
series:
...
tags:
  - http
draft: false
originalUrl: https://velog.io/@jsj9620/HTTP
thumbnail: https://velog.velcdn.com/images/jsj9620/post/94fbe4b9-03e4-4a66-9ef0-6a28453262fb/image.png
---
![](https://velog.velcdn.com/images/jsj9620/post/94fbe4b9-03e4-4a66-9ef0-6a28453262fb/image.png)
...
- `HTTP/2`에서 하나의 연결로 여러 요청/응답을 동시에 처리하는 Multiplexing 기술 등장
...
- `GET` 요청은 보통 본문이 비어있고, `POST`나 `PUT`은 서버에 생성하거나 수정할 데이터를 본문에 담아 보냄
...
- `200 OK`: 요청 성공
- `201 Created`: 리소스 생성 성공(`POST`, `PUT`에 대해)
